...
@Composable
fun MapsUI(appVM: AppVM, formVM: FormVM, permissionLauncher: ActivityResultLauncher<Array<String>>) {
    ...
    Column {
        ...
        Button(onClick = {
            ...
            routineScope.launch(Dispatchers.IO) {
                DataBase.getInstace(context).entityDao().updateLatLon(formVM.id.value, lat, lon)
